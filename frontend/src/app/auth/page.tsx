  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-8 shadow-2xl">
        ...
        {message && (
          <div
            className={`mt-5 rounded-xl border p-3 text-center text-sm ${message.toLowerCase().includes("success")
        ...
        <div className="mt-8 border-t border-slate-200 pt-6 text-center text-slate-500">
          ...
          <button
            ...
            disabled={loading}
            className="mt-4 w-full rounded-xl border border-slate-300 bg-white py-3 font-semibold text-slate-700 transition hover:bg-slate-50 hover:border-slate-400"
          >
            🚀 Try Demo without Signing In
          </button>

          <p className="mt-3 text-center text-xs text-slate-500">
            Explore DrawMeet instantly. Your demo board will expire automatically after
            24 hours.
          </p>
